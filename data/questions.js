...
export const MORNING_QUESTIONS = [
  ...
  },
  {
    id: 'mq_phone',
    number: '5b',
    text: 'After you first fell asleep, did you check your phone at any point during the night?',
    hint: 'This includes checking messages, social media, or just the time.',
    type: 'yes_no',
    followUp: 'mq_phone_count',
  },
  {
    id: 'mq_phone_count',
    number: '5c',
    text: 'About how many times did you check your phone?',
    type: 'number',
    defaultValue: 1,
    min: 1,
    max: 20,
    unit: 'times',
    conditionalOn: { id: 'mq_phone', value: 'yes' },
  },
  {
    id: 'mq7',
    number: 6,
